...
if exists (select 1
           ...
           where  id    = object_id('curriculum')
            ...
            and   indid > 0
            and   indid < 255)
   drop index curriculum."课程-修读方式_FK"
go
...
if exists (select 1
           ...
           where  id    = object_id('selftestscores')
            and   name  = 'selftestscores3_FK'
            and   indid > 0
            and   indid < 255)
   drop index selftestscores.selftestscores3_FK
go

if exists (select 1
            from  sysindexes
           where  id    = object_id('selftestscores')
            and   name  = 'selftestscores2_FK'
            and   indid > 0
            and   indid < 255)
   drop index selftestscores.selftestscores2_FK
go

if exists (select 1
            from  sysindexes
           where  id    = object_id('selftestscores')
            and   name  = 'selftestscores_FK'
            and   indid > 0
            and   indid < 255)
   drop index selftestscores.selftestscores_FK
go
...
if exists (select 1
            from  sysobjects
           where  id = object_id('studymode')
            and   type = 'U')
   drop table studymode
go
...
/* Index: "课程-修读方式_FK"                                          */
/*==============================================================*/
create index "课程-修读方式_FK" on curriculum (
studymode_id ASC
)
go
...
/*==============================================================*/
/* Index: selftestscores_FK                                     */
/*==============================================================*/
create index selftestscores_FK on selftestscores (
curriculum_code ASC,
number ASC,
qt_code ASC,
testpaper_code ASC
...
/*==============================================================*/
/* Index: selftestscores2_FK                                    */
/*==============================================================*/
create index selftestscores2_FK on selftestscores (
user_id ASC
)
go

/*==============================================================*/
/* Index: selftestscores3_FK                                    */
/*==============================================================*/
create index selftestscores3_FK on selftestscores (
tea_user_id ASC
)
go
...
create table studymode (
   ...
   constraint PK_STUDYMODE primary key nonclustered (studymode_id)
)
go
